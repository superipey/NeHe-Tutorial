// Lesson24.cpp : Defines the entry point for the application.
//
...
void objload(char *name, OBJECT *k)						// Loads Object From File (name)
{
	...
	sscanf(oneline, "Vertices: %d\n", &ver);			// Scans Text For L"Vertices: L".  Number After Is Stored In ver
	...
	int			nCmdShow)						// Window Show State
{
	...
	if (!CreateGLWindow(L"Piotr Cieslak & NeHe's Morphing Points Tutorial", 640, 480, 16, fullscreen))
	{
