...
int LoadGLTextures()                                    // Load Bitmaps And Convert To Textures
{
	...
	texture[0] = SOIL_load_OGL_texture("Data/BG.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	texture[1] = SOIL_load_OGL_texture("Data/BG.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	texture[2] = SOIL_load_OGL_texture("Data/BG.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

	texture[3] = SOIL_load_OGL_texture("Data/Reflect.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	texture[4] = SOIL_load_OGL_texture("Data/Reflect.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	texture[5] = SOIL_load_OGL_texture("Data/Reflect.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

	if (texture[0] == 0 || texture[1] == 0 || texture[2] == 0 || texture[3] == 0 || texture[4] == 0 || texture[5] == 0) return false;
	...
	while (!done) {
		...
		else                                // If There Are No Messages
		{
			...
			if (keys[' '] && !sp)       // Is Spacebar Being Pressed?
			{
				...
				if (object>3)     // Is object Greater Than 5?
