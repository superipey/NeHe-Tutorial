// Lesson22.cpp : Defines the entry point for the application.
//
...
int LoadGLTextures() {												// Load Bitmaps And Convert To Textures
	...
	texture[0] = SOIL_load_OGL_texture("Data/Base.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	texture[1] = SOIL_load_OGL_texture("Data/Base.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	texture[2] = SOIL_load_OGL_texture("Data/Base.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	...
	GLuint Image = SOIL_load_OGL_texture("Data/Bump.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
	...
	invbump[0] = SOIL_load_OGL_texture("Data/Base.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
																// Create Nearest Filtered Texture
