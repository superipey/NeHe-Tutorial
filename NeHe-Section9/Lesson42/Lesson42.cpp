// Lesson42.cpp : Defines the entry point for the application.
//
...
unsigned int const	width = 128;													// Maze Width  (Must Be A Power Of 2)
unsigned int const	height = 128;													// Maze Height (Must Be A Power Of 2)
