// Lesson43.cpp : Defines the entry point for the application.
//
...
#pragma comment( lib, "libfreetype.lib" )										// Search For GLu32.lib While Linking
	...
	int			nCmdShow)			// Window Show State
{
	...
	try {											// Use exception handling 
		...
		if (!CreateGLWindow("Lesson 43: NeHe & Sven Olsen's TrueType Font Tutorial", 640, 480, 16, fullscreen))
		{
		...
		while (!done)									// Loop That Runs While done=FALSE
		{
			...
			else										// If There Are No Messages
			{
				...
				if (keys[VK_F1])						// Is F1 Being Pressed?
				{
					...
					if (!CreateGLWindow("NeHe & Sven Olsen's TrueType Font Tutorial", 640, 480, 16, fullscreen))
					{
						return 0;						// Quit If Window Was Not Created
					}
				}
